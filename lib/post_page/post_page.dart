              ...
              child: Row(
                ...
                children: [
                  PostButton(onPressed: () async {
                    ...
                    if (algo.formKey.currentState!.validate()) {
                      print(algo.messageController.value.text.length);
...
class _PostBodyState extends State<PostBody> {
  ...
  Widget build(BuildContext context) {
    return Consumer<PostProvider>(
      builder: (context, algo, child) => SingleChildScrollView(
        child: Form(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: TextFormField(
                        ...
                        autovalidateMode: AutovalidateMode.onUserInteraction,
                        validator: (val) {
                         // print("VALUE IS: ${val!.length.toString()}");
                          String value = val!.toLowerCase();
                          if (value.length < 300) {
                            return "Message is to short must be 300 characters or more";
                          } else if (value.contains("fuck") ||
                              value.contains("shoot up") ||
                              value.contains("shit") ||
                              value.contains("ass") ||
